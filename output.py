...
gulshan-R510J:~$ python file.py &
	[1] 3088
	gulshan-R510J:~$ running
	running
	running
	running
...
gulshan-R510J:~$ python file.py > /dev/null
	no output
...
gulshan-R510J-R510J:~$ python file.py &> /dev/null
...
gulshan-R510J-R510J:~$ bash -c "python file.py"
	running
	running
	running
	running
gulshan-R510J:~$ bash -c "python file.py &" (Only works when no standard output stream)
	nihal@nihal-R510J:~$ running
	running
	running
	running

gulshan-R510J-R510J:~$ bash -c "python file.py &> /dev/null"
	no output. But runs on foreground.

gulshan:~$ bash -c "python file.py &> /dev/null &"
